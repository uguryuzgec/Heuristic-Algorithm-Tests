...
%---------------------------------
Theta_up=2*pi;		% 05.03.2016 Theta 0 - pi/2 aralýðýnda seçildi.
Theta_low=0;		% 05.03.2016 Theta 0 - pi/2 aralýðýnda seçildi.
katsayi=1;  		% 05.03.2016 katsayý 0.5 deðeri ile denenmeye baþlandý. 
radial_up=1;		% 05.03.2016 Theta 0 - pi/2 aralýðýnda seçildi.
radial_low=0.85;	% 05.03.2016 Theta 0 - pi/2 aralýðýnda seçildi.
% katsayi=0.9;		% 05.03.2016 katsayý 0.5 deðeri ile denenmeye baþlandý. 
%---------------------------------
...
% % % %  hold on; plot(popnokta(:,1),popnokta(:,2),'r.','MarkerSize',20); % BAÞLANGIÇ...%%% GUNCELLEME YAPILDI. 01.05.2016, UY...
